...
public final class SpecificCountryQuery: GraphQLQuery {
  ...
  public let operationDefinition: String =
    """
    query SpecificCountry($country: ID!) {
  ...
  public var country: GraphQLID

  public init(country: GraphQLID) {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        GraphQLField("country", arguments: ["code": GraphQLVariable("country")], type: .object(Country.selections)),
      ]
    }
    ...
    public struct Country: GraphQLSelectionSet {
      ...
      public init(name: String, native: String, capital: String? = nil, currency: String? = nil, emoji: String, languages: [Language], states: [State]) {
        self.init(unsafeResultMap: ["__typename": "Country", "name": name, "native": native, "capital": capital, "currency": currency, "emoji": emoji, "languages": languages.map { (value: Language) -> ResultMap in value.resultMap }, "states": states.map { (value: State) -> ResultMap in value.resultMap }])
      }
...
public final class GetCountriesListQuery: GraphQLQuery {
  /// The raw GraphQL definition of this operation.
  public let operationDefinition: String =
    """
  ...
  public let operationName: String = "getCountriesList"
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct Country: GraphQLSelectionSet {
      ...
      public init(name: String, emoji: String, capital: String? = nil, code: GraphQLID) {
        self.init(unsafeResultMap: ["__typename": "Country", "name": name, "emoji": emoji, "capital": capital, "code": code])
      }
